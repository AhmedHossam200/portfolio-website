...
if(isset($_POST['add_location'])){
 ...
 if(isset($_POST['add_book'])){
  ...
  if(isset($_POST['update_book'])){
      ...
      $query="UPDATE `book` SET `name`='$name',`d`='$description',`book_image`='$upload' WHERE id=$id";
      $stmt=$connection->prepare($query);
      $stmt->execute([]);
...
<body>
    ...
    <div class="d-flex flex-column">
      ...
      <nav id="navbar" class="nav-menu navbar">
        <ul>
          ...
          <li><a href="admin_book.php" class="nav-link scrollto active"><i class="bi bi-book"></i> <span>Books</span></a></li>
 ...
 <main id="main">
    ...
    <div class="container-fluid">
             ...
             <div class="col-md-8">
                 <h3 class="text-center text-info">Add new book</h3>
                 <form action="#" method="post" enctype="multipart/form-data">
                     <div class="form-group">
                     <input type="text" name="name" class="form-control" placeholder="Enter name" >
                     </div>
                     <div class="form-group">
                     <input type="text" name="d" class="form-control" placeholder="Enter book link" required>
                     </div>
                     ...
                     <div class="form-group">
                        <input type="submit" class="btn btn-primary btn-block" name="add_book" value="creat" >
                    </div>
        ...
        $statement = $connection->prepare($sql);
          $statement->execute([]);
            $people = $statement->fetchAll(PDO::FETCH_OBJ);
                 ...
                 ?>
                 <h3 class="text-center text-info">list of book  </h3>
...
<!--                  <td><?= $person->d; ?></td>-->
        <td>
                        ...
                        <a  href="delete_book.php?delete=<?= $person->id; ?>" class="badge badge-danger p-2">Delete</a>
    ...
    <div class="container-fluid">
             ...
             <div class="col-md-8">
                 <h3 class="text-center text-info">update book</h3>
                 <form action="#" method="post" enctype="multipart/form-data">
                      <div class="form-group">
                     ...
                     <div class="form-group">
                        <input type="submit" class="btn btn-primary btn-block" name="update_book" value="creat" >
                    </div>
