...
//     }
 ...
 if(isset($_POST['update_collab'])){
       $id=$_POST['id'];
      $name=$_POST['collab_desc'];
      $description=$_POST['collab_link'];

      $photo=$_FILES['file_image']['name'];
      $upload="image/".$photo;
       
      $query="UPDATE `collaboration` SET `collab_desc`='$name',`collab_link`='$description',`collab_img`='$upload' WHERE id=$id";
      $stmt=$connection->prepare($query);
      $stmt->execute([]);
    ...
    <div class="d-flex flex-column">
      ...
      <nav id="navbar" class="nav-menu navbar">
        <ul>
          ...
          <li><a href="admin_collab.php" class="nav-link scrollto active"><i class="bi bi-arrow-left-right"></i> <span>Collaborations</span></a></li>
...
<!--     ###### add new collaborations part ######-->
    ...
    <div class="container-fluid">
             ...
             <div class="col-md-8">
                 <h3 class="text-center text-info">Add new collaboration</h3>
                 <form action="#" method="post" enctype="multipart/form-data">
                     <div class="form-group">
                     <input type="text" name="collab_desc" class="form-control" placeholder="Enter collaboration description" required>
                     </div>
                     <div class="form-group">
                     ...
                     <div class="form-group">
                        <input type="submit" class="btn btn-primary btn-block" name="add_collab" value="creat" >
                    </div>
 ...
 <section class="section-2 container-fluid p-0">
        ...
        $statement = $connection->prepare($sql);
          $statement->execute([]);
            $people = $statement->fetchAll(PDO::FETCH_OBJ);
                 ...
                 ?>
                 <h3 class="text-center text-info">list of collaborations  </h3>
    ...
    <tbody>
      ...
      <tr>
                  <td> <?= $person->id; ?></td>
        <td> <?= $person->collab_desc; ?></td>

        <td>

                        <a  href="delete_collab.php?delete=<?= $person->id; ?>" class="badge badge-danger p-2">Delete</a>
    ...
    <div class="container-fluid">
             ...
             <div class="col-md-8">
                 <h3 class="text-center text-info">update collaboration</h3>
                 <form action="#" method="post" enctype="multipart/form-data">
                      <div class="form-group">
                     <input type="text" name="id" class="form-control" placeholder="Enter collaboration id" required>
                     </div>
                     <div class="form-group">
                     <input type="text" name="collab_desc" class="form-control" placeholder="Enter collaboration description" required>
                     </div>
                     ...
                     <div class="form-group">
                        <input type="submit" class="btn btn-primary btn-block" name="update_collab" value="creat" >
                    </div>
    ...
    <div class="container-fluid">
             ...
             <div class="col-md-4">
                 ...
                 <form action="#" method="post" enctype="multipart/form-data">
                     ...
                     <div class="form-group">
                        <input type="submit" class="btn btn-primary btn-block" name="add_teach" value="creat" >
                    </div>
