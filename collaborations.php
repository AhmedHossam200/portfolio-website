        ...
        <ul>
         <li><a href="index.php" class="nav-link scrollto "><i class="bx bx-home"></i> <span>Home</span></a></li>
          ...
          <li><a href="tech.php" class="nav-link scrollto"><i class="bx bx-server"></i> <span>Teaching</span></a></li> 
            <li><a href="collaborations.php" class="nav-link scrollto active"><i class="bi bi-arrow-left-right"></i> <span>Collaborations</span></a></li>
...
<!--          <p>Magnam dolores commodi suscipit. Necessitatibus eius consequatur ex aliquid fuga eum quidem. Sit sint consectetur velit. Quisquam quos quisquam cupiditate. Et nemo qui impedit suscipit alias ea. Quia fugiat sit in iste officiis commodi quidem hic quas.</p>-->
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div >
              <a href="<?= $person2->collab_link; ?>"><img src="<?= $person2->collab_img; ?>" class="img-fluid" alt="" style="left: 0px; top: 0px width: 200px; height: 200px; border: 0px; padding: 0px; margin: 0px; max-width: none;"></a>
             
                <h3><?= $person2->collab_desc; ?></h3>
            </div>
          </div>
    <?php endforeach; ?>   
